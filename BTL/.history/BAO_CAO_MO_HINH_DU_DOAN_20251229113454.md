...
Để minh họa cách sử dụng hàm dự đoán, ta thử với một trường hợp cụ thể: một Data Analyst cấp Senior, làm việc Full-time trong ngành Tech tại công ty lớn.
...
Kết quả cho thấy mức lương dự đoán khoảng ~$145,000/năm - phù hợp với thực tế thị trường cho vị trí Senior Data Analyst tại các công ty công nghệ lớn.
...
|--------|-------------|-------|--------|---------------|
| Data Analyst | Senior | Tech | Large | ~$145,000 |
| NLP Engineer | Mid | Tech | Large | ~$110,000 |
| AI Product Manager | Entry | Tech | Mid | ~$65,000 |
